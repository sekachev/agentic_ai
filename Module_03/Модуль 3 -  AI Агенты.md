...
+ <span style="color:orange">Восприятие</span>: кнопки, формы и интерфейс позволяют структурировать ввод
...
+ <span style="color:orange">Поиск знаний</span>: не может сам искать и понимать глубокий контекст
...
+ <span style="color:orange">Архитектурная слепота</span>: могут сломать общую логику приложения

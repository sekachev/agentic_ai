# Source: https://mszturc.github.io/obsidian-advanced-slides
...
, which means that in most cases it is sufficient to simply write a Slide in **Obsidian Markdown syntax**.
...
- Image Support
- include images through Obsidian Synthax -
`![[picture.jpg]]`
...
will be rendered as normal text in Presentation
- with aliases
`[[Note|My Note]]`

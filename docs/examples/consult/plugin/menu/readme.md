# Source: https://mszturc.github.io/obsidian-advanced-slides/examples/consult/plugin/menu/readme
...
attribute.If the slide’s section element contains a `data-menu-title`
...
.If the slide’s section contains an element with the class `menu-title`
...
to load html from another file.`content`

and this will be added to the custom panel.You can provide menu items in your custom panels using the following format. This allows you to define your own navigation links for your presentation.

# Source: https://mszturc.github.io/obsidian-advanced-slides/layout/grid
...
As you have surely seen in the example, you can combine Fragments and [Fragment Lists](/obsidian-advanced-slides/extend-syntax/fragments/) with each other. By default, Fragment Lists generate indexes that start at 1.

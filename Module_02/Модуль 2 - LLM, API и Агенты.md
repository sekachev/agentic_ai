...
| Тип кванта | Пример $\pi$ | Вес (VRAM + KV Cache) | Железо (Enterprise / Pro Grade) | Цена системы «под ключ» | Качество ответов |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **BF16** | 3.14159265 | **~800 ГБ** | Cluster: 2x NVIDIA HGX H100 (16 GPU) | **$650,000** | Идеальное (Reference) |
| **Q8_0** | 3.14159 | **~420 ГБ** | Server: 1x NVIDIA HGX H100 (8 GPU) | **$320,000** | Неотличимо |
| **Q6_K** | 3.1415 | **~330 ГБ** | Server: 8x NVIDIA RTX 6000 Ada | **$130,000** | Почти без потерь |
| **Q4_K_M** | 3.14 | **~240 ГБ** | Server: 8x NVIDIA L40S (48GB) | **$100,000** | **Золотой стандарт** |
| **IQ3_XXS** | 3.1 | **~165 ГБ** | Workstation: 4x NVIDIA RTX 6000 Ada | **$60,000** | Заметная деградация |
| **IQ2_XXS** | 3.0 | **~130 ГБ** | Workstation: 4x NVIDIA L40S | **$45,000** | Глупые ошибки |
| **TQ1_0** | 1 | **~90 ГБ** | Consumer: 4x NVIDIA RTX 3090 (24GB) | **$5,000** | "Белый шум" / Бред |
